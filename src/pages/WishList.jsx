        ...
        <div className='mt-20 mb-35'>
            <Container>
                ...
                <div className='flex justify-between items-center'>
                    <span></span>
                    <button className='border border-gray-400 px-12 py-4 rounded-sm'>Move All To Bag</button>
                </div>
                ...
                <div className='pt-20'>
                    <div className='flex justify-between items-center'>
                        ...
                        <button className='border border-gray-400 px-12 py-4 rounded-sm'>See All</button>
                    </div>
